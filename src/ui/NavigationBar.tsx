    ...
    <div className="navigation-container">
      <div className="browser-toolbar">
        <div className="nav-buttons">
          <button onClick={handleGoBack} className="nav-button" title="Go back">
            &#8592;
          </button>
          <button
          ...
          <button onClick={handleNewTab} className="nav-button" title="New tab">
            +
          </button>
        </div>
        ...
        <button onClick={handleNavigate} className="go-button">
          Go
        </button>
      </div>
    </div>
