...
import { TAB_BAR_HEIGHT, NAVIGATION_HEIGHT, HEADER_HEIGHT } from '../constants/appConstants';
...
export class WindowManager implements IWindowManager {
    ...
    private async loadUIComponents(): Promise<void> {
        ...
        if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
            this.tabsView.webContents.loadURL(`${MAIN_WINDOW_VITE_DEV_SERVER_URL}#tabs`);
        } else {
        ...
        if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
            this.navigationView.webContents.loadURL(`${MAIN_WINDOW_VITE_DEV_SERVER_URL}#navigation`);
        } else {
        ...
        await Promise.all([
            ...
            new Promise<void>(resolve => {
                if (this.navigationView) {
                    this.navigationView.webContents.once('did-finish-load', () => resolve());
                } else {
                    resolve();
                }
            })
